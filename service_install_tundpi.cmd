...
sc stop "TunDPI"
sc delete "TunDPI"
sc create "TunDPI" binPath= "\"%CD%\%_arch%\goodbyedpi.exe\" -5 --set-ttl 5 --dns-addr 77.88.8.8 --dns-port 1253 --dnsv6-addr 2a02:6b8::feed:0ff --dnsv6-port 1253" start= "auto"
sc description "TunDPI" "TunDPI - Discord icin ozel DPI atlatma araci."
sc start "TunDPI"
