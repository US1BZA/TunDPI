...
sc stop "TunDPI"
sc delete "TunDPI"
sc create "TunDPI" binPath= "\"%CD%\%_arch%\goodbyedpi.exe\" -1 --set-ttl 5 --dns-addr 77.88.8.8" start= "auto"
sc description "TunDPI" "TunDPI - Discord icin ozel DPI atlatma araci (SuperOnline alternatif 4)."
sc start "TunDPI"
